...
# №2.3[13]. Уставшие от необычно теплой зимы, 
# жители решили узнать, действительно ли это самая длинная оттепель 
# за всю историю наблюдений за погодой. 
...
# в который среднесуточная температура ежедневно превышала 0 градусов 
...
min=1000
while i<n:
    weight=int(input("Input watermelon weight "))
    if max<weight:
        max=weight
    if min>weight:
        min=weight
